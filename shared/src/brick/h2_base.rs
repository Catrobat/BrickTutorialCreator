...
impl_brick_wrapper!(BrickH2Base, super::H2_BASE_SPEC);

impl SVGRenderable for BrickH2Base {
    fn to_svg(&self) -> String {
        let width = super::H2_BASE_SPEC.width;
        let height = super::H2_BASE_SPEC.height;
