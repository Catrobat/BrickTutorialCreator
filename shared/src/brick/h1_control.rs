use crate::common::{Brick, SVGRenderable};

impl_brick_wrapper!(BrickH1Control, super::H1_CONTROL_SPEC);

impl SVGRenderable for BrickH1Control {
    fn to_svg(&self) -> String {
        let width = super::H1_CONTROL_SPEC.width;
        let height = super::H1_CONTROL_SPEC.height;
        ...
        format!("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 {width} {height}\">
            ...
            // bottom
             <g>
                ...
                <path class=\"border\"
                    d=\"M347.736,66.657l-315.056,0.001l0,0.008l-1.749,4.117l-16.858,0l-1.752,-4.126l-0.019,0.008l0,-0.007l-12.302,0l0,2l10.998,0l1.748,4.115l0.005,-0.002l0,0.012l19.502,0l0,-0.003l0.002,0.001l1.752,-4.123l314.17,-0.001l0,-2z\" />
            </g>
            {}
        </svg>",
        self.parse_content())
