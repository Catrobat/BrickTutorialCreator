...
impl_brick_wrapper!(BrickH1Base, super::H1_BASE_SPEC);

impl SVGRenderable for BrickH1Base {
    fn to_svg(&self) -> String {
        let width = super::H1_BASE_SPEC.width;
        let height = super::H1_BASE_SPEC.height;
