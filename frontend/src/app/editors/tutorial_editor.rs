...
use crate::app::editors as style;
#[cfg(target_arch = "wasm32")]
...
#[cfg(target_arch = "wasm32")]
use crate::components::export_bar::ExportBar;
#[cfg(target_arch = "wasm32")]
            ...
            <div class={style::TUTORIAL_EDITOR_CONTENT}>
                ...
                if props.export_mode {
                    <ExportBar
                        ...
                        total_items={props.total_bricks}
                        on_select_all={props.on_export_select_all.clone()}
                        on_clear={props.on_export_clear.clone()}
                        on_export_json={props.on_export_json.clone()}
                        on_export_png={props.on_export_png.clone()}
                        on_export_svg={props.on_export_svg.clone()}
                        on_done={props.on_exit_export.clone()}
                    />
                }
                if preview {
