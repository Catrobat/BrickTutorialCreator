...
use crate::app::views::view as style;
#[cfg(target_arch = "wasm32")]
use crate::{
    components::brick_view::BrickView,
    components::drag_drop::drag_drop_list::{DragDropItem, DragDropList},
    interfaces::brick::BrickState,
};

#[cfg(target_arch = "wasm32")]
use crate::app::{ICON_MOVE_DOWN, ICON_MOVE_UP};
                                                ...
                                                html! {
                                                    <>
                                                        <button
                                                            ...
                                                            disabled={idx == 0}
                                                            aria-label="Move brick up"
                                                            title="Move brick up"
                                                        >
                                                            {Html::from_html_unchecked(AttrValue::from(ICON_MOVE_UP))}
                                                        </button>
                                                        ...
                                                        <button
                                                            ...
                                                            disabled={idx + 1 >= len}
                                                            aria-label="Move brick down"
                                                            title="Move brick down"
                                                        >
                                                            {Html::from_html_unchecked(AttrValue::from(ICON_MOVE_DOWN))}
                                                        </button>
                                                    </>
                                                }
                                            } else {
